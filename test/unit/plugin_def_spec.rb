...
# the inspec-tfkit plugin is configured correctly.

require "minitest/autorun"

# Load the class under test, the Plugin definition.
require "inspec-tfkit/plugin"

# In general, plugin authors can choose many different test harnesses, such as RSpec or Minitest/Spec.
# However, tfkit loads all of InSpec, which causes interference with both of those, so here we use
